# Claude – Fuffa project instructions

This file is referenced from [AGENT.md](AGENT.md). Use it when working on **Fuffa** with Claude.
...
- Follow standard Go style and existing patterns in `pkg/xdp-ebpf/`.
